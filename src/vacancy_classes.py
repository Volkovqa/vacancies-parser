class Vacancy:
    ...
    """
    Класс для вакансий - собирает данные о названии вакансии, описание, зарплату, ссылку на вакансию.
    Предназначен для упорядочения информации о вакансиях, поступающей с платформ, приведению её к единому виду.
    Удобный вывод для пользователя. Удобная работа для разработчика.
    """
